...
//  Project 11
//
//  Created by Gökhan Gökoğlan on 8.03.2023.
//
...
class GameScene: SKScene , SKPhysicsContactDelegate {
    ...
    override func didMove(to view: SKView) {
        ...
        ballCountLabel.text = "5 Balls Left"
        ballCountLabel.horizontalAlignmentMode = .right
        ballCountLabel.position = CGPoint(x: 610, y: 700)
    ...
    override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        let balls = ["ballRed", "ballPurple", "ballCyan", "ballGreen", "ballBlue", "ballYellow", "ballGrey"]
